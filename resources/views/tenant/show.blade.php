            ...
            <div class="card user-card">
                ...
                <div class="card-body text-center">
                    <div class="user-imgwrap"><img class="img-fluid rounded-circle"
                            src="{{ optional($tenant->profile_image) ? Storage::url($tenant->profile_image) : asset('assets/images/profile/user-13.png') }}"
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="stat-card">
                        ...
                        <p>{{ $financialSummary['total_installments'] }} </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat-card">
                        ...
                        <p>{{ $financialSummary['paid_installments'] }} </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat-card">
                        ...
                        <p>{{ $financialSummary['due_installments'] }} </p>
                    </div>
                </div>
            </div>
            <div class="row g-3">
                            ...
                            <tbody>
                                @forelse($tenant->installments as $installment)
                                    <tr>
                                        ...
                                        <td>{{ Str::limit($installment->notes, 40) }}</td>
                                        ...
                                        <td class="text-center">
                                            {{-- ✅ NEW: Edit Notes Button --}}
                                            <a href="#" class="btn btn-sm btn-outline-secondary customModal"
                                                data-url="{{ route('installment.notes.edit', $installment->id) }}"
                                                data-title="Edit Notes for Installment #{{ $installment->installment_number }}"
