                ...
                <div class="card blog-wrapper">
                    <div class="imgwrapper">
                        <img class="img-fluid property-img"
                            src="<?php echo e(asset(Storage::url('upload/thumbnail')) . '/' . $thumbnail); ?>"
                    ...
                    <div class="detailwrapper">
                        ...
                        <ul class="blogsoc-list">
                            <li><a href="#"><i data-feather="layers"></i><?php echo e($property->totalUnit()); ?>

                                    <?php echo e(__('Unit')); ?></a></li>
                            <li><a href="#"><i data-feather="layout"></i><?php echo e($property->totalRoom()); ?>

                                    <?php echo e(__('Rooms')); ?></a></li>
                        </ul>
                            ...
                            <div class="date-info">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit property')): ?>
                                    <a class="text-success" data-bs-toggle="tooltip"
                                        ...
                                        href="<?php echo e(route('property.edit', $property->id)); ?>"> <i data-feather="edit"></i></a>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\JOWEB\property\resources\views/property/index.blade.php ENDPATH**/ ?>