        ...
        <ul class="codex-menu custom-scroll" data-simplebar>
            ...
            <?php if(Gate::check('manage property') ||
                ...
                <?php if(Gate::check('manage tenant') || Gate::check('manage property') || Gate::check('manage unit')): ?>
                    <li
                        class="menu-item <?php echo e(in_array($routeName, ['property.index', 'property.create', 'property.edit', 'property.show', 'unit.index']) ? 'active' : ''); ?>">
                        ...
                        <ul class="submenu-list"
                            ...
                            <?php if(Gate::check('manage property')): ?>
                                <li
                                    class=" <?php echo e(in_array($routeName, ['property.index', 'property.create', 'property.edit', 'property.show']) ? 'active' : ''); ?> ">
                ...
                <?php if(Gate::check('manage tenant')): ?>
                    <li
                        class="menu-item <?php echo e(in_array($routeName, ['tenant.index', 'tenant.create', 'tenant.edit', 'tenant.show']) ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('tenant.index')); ?>">
                            <div class="icon-item"><i data-feather="user"></i></div>
                            <span><?php echo e(__('Buyers')); ?> </span>
                        </a>
                    </li>
                <?php endif; ?>
            ...
            <?php if(Gate::check('manage property') ||
                ...
                <?php if(Gate::check('manage maintainer') || Gate::check('manage maintenance request')): ?>
                    <li
                        class="menu-item <?php echo e(in_array($routeName, ['maintenance-request.index', 'maintenance-request.pending', 'maintenance-request.inprogress']) ? 'active' : ''); ?>">
                        <a href="javascript:void(0);">
                        ...
                        <ul class="submenu-list"
                            ...
                            <?php if(Gate::check('manage maintenance request')): ?>
                                <li
                                    class=" <?php echo e(in_array($routeName, ['maintenance-request.pending']) ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('maintenance-request.pending')); ?>"><?php echo e(__('Pending')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(Gate::check('manage maintenance request')): ?>
                                <li
                                    class=" <?php echo e(in_array($routeName, ['maintenance-request.inprogress']) ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('maintenance-request.inprogress')); ?>"><?php echo e(__('In Progress')); ?>
                ...
                <?php if(Gate::check('manage invoice') || Gate::check('manage expense')): ?>
                    <li
                        class="menu-item <?php echo e(in_array($routeName, ['invoice.index', 'invoice.create', 'invoice.edit', 'invoice.show', 'expense.index']) ? 'active' : ''); ?>">
                        <a href="javascript:void(0);">
                        ...
                        <ul class="submenu-list"
                            ...
                            <?php if(Gate::check('manage invoice')): ?>
                                <li
                                    class=" <?php echo e(in_array($routeName, ['invoice.index', 'invoice.create', 'invoice.edit', 'invoice.show']) ? 'active' : ''); ?>">
...
<!-- sidebar end-->
<?php /**PATH O:\JOWEB\property\resources\views/admin/menu.blade.php ENDPATH**/ ?>